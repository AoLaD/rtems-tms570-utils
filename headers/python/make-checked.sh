list="ADC CCMSR CRC DCAN DCC DMA DMM EFUSE EMACC EMACM EMIF ESM FLASH FLEX_RAY GIO HTU I2C IOMM LIN MDIO N2HET PBIST PLL PMM RTI RTP SCI TCR TCRAM VIM POM SPI STC SYS SYS2 PCR"
dest="../headers"
mkdir -p "$dest"
for a in $list ; do
